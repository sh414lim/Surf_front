    ...
    <>
      <Grid
        ...
        sx={{
          ...
          boxShadow: "3px 5px 3px 5px rgba(0,0,0,0.2)",
          borderRadius: "20px",
          backgroundImage: `url(https://images.unsplash.com/photo-1502680390469-be75c86b636f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8c3VyZnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60)`,
          "&:hover": {
